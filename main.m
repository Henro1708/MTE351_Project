...
measuring = 1000;      % m to mm for plotting

% Generate 1 groove profile (haversine)
dx = linspace(0, L_groove, L_groove*measuring);
...
n_tiles = floor(total_distance / (tile_size + L_groove));

% initialize path
path = [];

while length(path) < total_distance * measuring
